...
def run_complete_analysis(params, save_plots=True, show_plots=False):
    ...
    if discovery is not None:
        ...
        fig2 = viz.plot_sindy_comparison(
            comparison_results['true_solution'][1:],
            comparison_results['discovered_solution'][1:],
            comparison_results['time'][1:],
            comparison_results
        )
    ...
    if Xi_drift_simpy is not None and discovery_simpy is not None:
        ...
        fig2b = viz.plot_sindy_comparison(
            comparison_results_simpy['true_solution'][1:],
            comparison_results_simpy['discovered_solution'][1:],
            comparison_results_simpy['time'][1:],
...
if __name__ == "__main__":
    ...
    scalings = [1, 10, 50, 100, 500, 1000, 5000]
    for param in params:
